            ...
            <div class="card-body">
                <form method="post" action="controller/cek_login.php">
                    <div class="row d-flex justify-content-center align-items-center">
                        ...
                        <div class="col">
                            <h1 class="text-center textHome fw-bold">LOGIN</h1>
                            <div class="group">
                            ...
                            <div class="group">
                                <div class="row">
                                    <div class="col">
                                        <input type="submit" class="btn tombolLogin text-light" style="width: 100%;" value="Login">
                                        <p>Belum memiliki akun?<a href="sign_up.php"> Klik disini</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
